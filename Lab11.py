...
# 5) Числовые харкатеристики выборки
...
mu_hat_mle, sigma_hat_mle = stats.norm.fit(sorted_range)
print(f"Метод максимального правдоподобия: mu = {mu_hat_mle:.4f}, sigma = {sigma_hat_mle:.4f}")
